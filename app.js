...
const translations = {
  ua: {
    ...
    hero_p1: "Немовлята від 3 місяців до 3 років",
    hero_p2: "Діти від 3 до 14 років",
    ...
    coach_cred_2: "Диплом бакалавра зі спеціальності «Дошкільна освіта та фізичне виховання»",
    ...
    intro_baby_desc: "Заняття для малюків від 3 місяців до 3 років з делікатною адаптацією до води.",
    ...
    prog_baby_kicker: "Від 3 місяців до 3 років",
    prog_baby_title: "Плавання для немовлят",
    prog_baby_desc: "Перший контакт з водою через довіру, гру та м’яке знайомство з басейном. Заняття проходять у форматі, комфортному для дитини та батьків.",
    prog_kids_kicker: "Від 3 до 14 років",
    ...
    price_2_kicker: "Індивідуальні заняття для немовлят до трьох років",
